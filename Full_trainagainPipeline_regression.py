...
for i in tqdm(range(10), desc="Runs voltooid"):
    ...
    output_path = f"Dannyfolder/Output/PapagAIo_ALL_EXTERNALS_LogReg_run{i+1}.txt"
    all_results = []
    ...
    for ext_label, ext_path in external_test_paths.items():
        ...
        pipeline = Pipeline([
            ...
            ('clf', LogisticRegression(class_weight=class_weight_dict, C=1.0, max_iter=1000, random_state=42 + i))
        ])
