...
for i in tqdm(range(10), desc="Runs voltooid"):
    ...
    output_path = f"Dannyfolder/Output/PapagAIo_ALL_EXTERNALS_RF_run{i+1}.txt"
    all_results = []
    ...
    for ext_label, ext_path in external_test_paths.items():
        ...
        pipeline = Pipeline([
            ...
            ('clf', RandomForestClassifier(class_weight=class_weight_dict, n_estimators=100, random_state=42 + i))
        ])
