...
for i in tqdm(range(10), desc="Runs voltooid"):
    ...
    # Bijv. als PapagAIo_train = 70, dan ext_train = round(70 * (0.3/0.7)) = 30
    ...
    for ext_label, ext_path in external_test_paths.items():
        ...
        if n_ext_train >= max_ext_available:
            # Als n_ext_train >= aantal beschikbare rijen, gebruik 90% voor train en 10% voor test
            train_frac = 0.9
        ...
        # 4d) Bereken class weights voor de Random Forest
        ...
        # 4e) Pipeline bouwen en trainen met Random Forest
        pipeline = Pipeline([
