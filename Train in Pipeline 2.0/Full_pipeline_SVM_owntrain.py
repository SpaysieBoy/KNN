...
for i in tqdm(range(10), desc="Total runs"):  # i = 0..9
    ...
    # Save per-run file
    save_path = f"Text_File/Train in pipeline 2.0/SVM/Full_MultiDataset_Run{i+1}.txt"
...
# Save summary file
summary_path = f"Text_File/Train in pipeline 2.0/SVM/Statistical_Summary.txt"
