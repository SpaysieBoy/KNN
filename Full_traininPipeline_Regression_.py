...
for i in tqdm(range(10), desc="Runs voltooid"):
    ...
    output_path = f"Dannyfolder/Output/Full_PapagAIo_LR+pipeline{i+1}.txt"
    ...
    # === Pipeline met BERT + Logistic Regression
    pipeline = Pipeline([
    ...
    results = ["=== EVALUATIE OP PAPAGAIO TESTDATA (Logistic Regression) ===\n", report, conf_matrix_text, auc_text, "\n"]
    ...
    print(f"✅ Evaluatie Run {i+1} (Logistic Regression) opgeslagen in: {output_path}")
